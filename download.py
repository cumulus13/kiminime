...
def download(url, saveas = None, download_path = os.getcwd(), proxies = {}, session = None, add_ext = False, max_try = 10, overwrite = True):
    debug(url = url)
    debug(saveas = saveas)
...
def download_img(url, saveas = None, download_path = os.getcwd(), proxies = {}, add_ext = False, max_try = 10, overwrite = True):
    if proxies:
        proxies = {}
    debug(url = url)
    debug(saveas = saveas)
